...
const ReadBoardComponent = React.lazy(() => import('./components/ReadBoardComponent'))
const CreateBoardComponent = React.lazy(() => import('./components/CreateBoardComponent'))
...
const routes = [
  ...
  { path: '/base/tables/:pageno', name: 'Tables', component: Tables },
  ...
  { path: '/create-board/:no&:pageno', name: 'create-board', component: CreateBoardComponent },
  { path: '/read-board/:no&:pageno', name: 'read-board', component: ReadBoardComponent },
]
